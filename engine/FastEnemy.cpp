...
short FastEnemy::getTypeID() {
    return 2;
}

FastEnemy::FastEnemy(const Context &c) {
...
void FastEnemy::update(Context &context) {
...
void FastEnemy::takeDamage(unsigned short amount, Context &context) {
    health -= amount;
    if (health <= 0) {
